...
const I18N = {
  en: {
    ...
    medianIs: (v) => `midpoint ${v} — blue below, red above`,
    ...
    smallHintYear: (scope) => `Each year on the same twelve months, one panel per offence, for ${scope}. Each panel keeps its own vertical scale, and the panels run from the sharpest rise this year to the sharpest fall. Click a panel to filter to that offence.`,
    smallHintGov: (scope) => `The whole record for ${scope}, one panel per offence, with each government shaded behind it. Each panel keeps its own vertical scale, and the panels run from the sharpest rise under this government to the sharpest fall. Click a panel to filter to that offence.`,
    ...
    footMeta: (a, b, n, u, c, total, first) =>
      `Analysis covers ${a} to ${b} — ${n} monthly sheets across ${u} jurisdictions and ${c} offence categories, counting dacoity, robbery and burglary as one. ${total} sheets from ${first} are held in the repository, with all fifteen source columns intact. The analyses were done by Sushmit Asif and Istiak Akib`,
  ...
  bn: {
    ...
    medianIs: (v) => `মাঝামাঝি ${v} — নিচে নীল, উপরে লাল`,
    divisionWord: 'বিভাগ',
    ...
    smallHintYear: (scope) => `${scope}-এর জন্য প্রতিটি অপরাধের আলাদা প্যানেল, প্রতিটি বছর একই বারো মাসের উপর। প্রতিটি প্যানেলের নিজস্ব মাপকাঠি, আর এ বছর যেটি সবচেয়ে বেড়েছে সেটি আগে, সবচেয়ে কমেছে সেটি শেষে। কোনো প্যানেলে ক্লিক করলে সেই অপরাধেই সীমাবদ্ধ হবে।`,
    smallHintGov: (scope) => `${scope}-এর পুরো সময়কাল, প্রতিটি অপরাধের আলাদা প্যানেল, পেছনে কোন সরকার কখন ছিল তা রঙে দেখানো। প্রতিটি প্যানেলের নিজস্ব মাপকাঠি, আর এই সরকারের সময়ে যেটি সবচেয়ে বেড়েছে সেটি আগে, সবচেয়ে কমেছে সেটি শেষে। কোনো প্যানেলে ক্লিক করলে সেই অপরাধেই সীমাবদ্ধ হবে।`,
    ...
    footMeta: (a, b, n, u, c, total, first) =>
      `বিশ্লেষণের সময়কাল ${a} থেকে ${b} — ${u}টি এখতিয়ার আর ${c} ধরনের অপরাধ নিয়ে মোট ${n} মাসের হিসাব; ডাকাতি, দস্যুতা ও সিঁধেল চুরি একসঙ্গে ধরা হয়েছে। ${first} থেকে শুরু করে ${total} মাসের তথ্য সংরক্ষিত আছে, উৎসের পনেরোটি কলামই অক্ষত। বিশ্লেষণের কাজ করেছেন সুস্মিত আসিফ এবং ইশতিয়াক আকিব।`,
